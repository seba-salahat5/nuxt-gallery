<template>
    <div class="w-full flex justify-end relative group">
        <img :src="src" class="object-fill sm:w-72 h-96" />
        <div class="absolute top-0 right-0 mr-2 mt-2">
            <svg @click="removeImage" class="w-6 h-6 fill-none group-hover:fill-white stroke-1 cursor-pointer"
...
export default defineComponent({
    ...
    methods: {
        removeImage() {
            ...
            const index = imageStore.uploadedImages.indexOf(this.src);
            if (index !== -1) {
